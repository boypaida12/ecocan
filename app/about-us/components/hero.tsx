  ...
  return (
    <>
      ...
      <div className="lg:h-[36rem] xl:h-[47.575rem]">
        <div className="bg-[url('/assets/images/about/about-hero.svg')] lg:h-[32rem] xl:h-[44rem] lg:bg-contain xl:bg-cover relative after:absolute after:inset-0 after:content-[''] after:bg-black/40 after:opacity-70 after:z-10">
