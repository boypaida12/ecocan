...
const cards = [
  ...
  },
  {
    ...
    description:
      "Our advanced recycling solutions ensure efficient and environmentally friendly packaging recycling processes.",
      ...
      <div className="bg-[#FAFAFA]">
        <div className="space-y-24 py-8 max-w-[77.5rem] mx-auto px-4 xl:px-0">
          ...
          <CtaCard
            ...
            image={
              <div className="w-[36.575rem] h-[22.625rem] mx-auto">
                <Image
