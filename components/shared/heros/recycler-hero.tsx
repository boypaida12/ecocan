  ...
  return (
    <>
      ...
      <div className="lg:h-[36rem] xl:h-[47.575rem]">
        <div className="bg-[url('/assets/images/recycler/recycler-bg.png')] lg:h-[36rem] xl:h-[44rem] bg-cover relative after:absolute after:inset-0 after:content-[''] after:bg-black/90 after:opacity-50 after:z-10">
            ...
            <div className="mt-60 px-4 xl:px-0 text-white z-50 mx-auto w-[70.625rem] text-left">
              ...
              <div className="tracking-wide text-sm lg:text-base xl:text-lg font-light text-white my-10 space-y-4">
                <p className="text-left">
                  Cut your recyclate processing loss rate, with<br/>
