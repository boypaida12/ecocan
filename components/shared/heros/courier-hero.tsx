  ...
  return (
    <>
      ...
      <div className="lg:h-[36rem] xl:h-[47.125rem]">
        <div className="bg-[url('/assets/images/courier-bg.jpeg')] lg:h-[32rem] xl:h-[42rem] lg:bg-contain xl:bg-cover relative after:absolute after:inset-0 after:content-[''] after:bg-black/90 after:opacity-0 after:z-10">
